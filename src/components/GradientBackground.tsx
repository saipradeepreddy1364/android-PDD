      ...
      <View style={styles.container}>
        ...
        <div
          style={{
            ...
            bottom: 0,
            background: `
              radial-gradient(ellipse 80% 60% at 0% 0%, rgba(56, 189, 248, 0.14) 0%, transparent 70%),
              radial-gradient(ellipse 60% 80% at 100% 0%, rgba(125, 211, 252, 0.12) 0%, transparent 60%),
              radial-gradient(ellipse 70% 50% at 100% 100%, rgba(251, 191, 36, 0.10) 0%, transparent 70%),
              radial-gradient(ellipse 50% 60% at 0% 100%, rgba(253, 224, 71, 0.08) 0%, transparent 60%),
              radial-gradient(ellipse 40% 40% at 50% 50%, rgba(147, 197, 253, 0.06) 0%, transparent 50%),
              radial-gradient(ellipse 90% 40% at 30% 20%, rgba(167, 243, 208, 0.08) 0%, transparent 60%),
              radial-gradient(ellipse 60% 30% at 70% 80%, rgba(254, 215, 170, 0.10) 0%, transparent 55%),
...
const styles = StyleSheet.create({
  ...
  blobBottomLeft: {
    ...
    width: 260,
    height: 260,
    backgroundColor: "rgba(253, 224, 71, 0.047)",
  },
  blobCenter: {
    top: "35%",
    left: "30%",
